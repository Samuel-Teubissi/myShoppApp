                ...
                <div className="motif-block">
                    {notifs?.map((notif, key) => (
                        <div className='motif-item flex space-x-2 mb-2' key={key}>
                            ...
                            <div className={`bg-transparent rounded rounded-s-none p-4 border-l-4 border-app-h flex-grow text-left pb-6 tracking-wide ${notif.notif_status === 'unread' && 'bg-app-500/30 dark:bg-app-300/10'}`}>

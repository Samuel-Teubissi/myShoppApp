                ...
                <div className="motif-block">
                    {notifs?.map((notif, key) => (
                        <div className='motif-item flex space-x-2 mb-2' key={key}>
                            ...
                            <div className={`bg-gray-50 dark:bg-app-300/10 shadow p-4 border-l-2 border-app-h flex-grow text-left pb-6 tracking-wide ${notif.notif_status === 'unread' && 'bg-app-400/20 dark:bg-app-300/50'}`}>

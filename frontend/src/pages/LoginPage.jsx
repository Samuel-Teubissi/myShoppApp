            ...
            <div className="text-center overflow-hidden relative backdrop-blur md:backdrop-blur-none md:w-8/12 h-full md:h-min flex flex-col justify-center items-center rounded-xl md:border dark:border-none md:border-app-200 sm:shadow-md shadow-none">
                ...
                <form className="w-full text-gray-600 py-10 sm:bg-app-100/5 sm:dark:bg-app-600/10 backdrop-blur flex justify-center flex-wrap dark:text-dark-app-100 overflow-hidden" onSubmit={LoginSubmit}>
                    ...
                    <div className="w-full flex justify-center mt-4">
                        <button type="submit" className={`text-white flex items-center justify-center rounded py-5 md:h-[45px] w-[90%] md:w-40 text-lg bg-app-600 hover:bg-app transition duration-300 ease-in-out ${isLoggingLoad && " text-center text-white cursor-not-allowed"}`} disabled={isLoggingLoad}>
                            {!isLoggingLoad
                                ? 'Connexion'

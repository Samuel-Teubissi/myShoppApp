...
const UserPage = () => {
  ...
  return (
    <div id="scroll-container">
      ...
      <div className="">
        <div className="pt-16 text-white pb-1 w-full px-3 banner_trader text-center">
            ...
            {isLogging ? (
              ...
              <div className="bg-app-h/50 pt-10 p-5 xl:pt-4 xl:pr-6 w-full xl:w-[60%] rounded-xl mx-auto flex flex-col xl:flex-row justify-center items-center gap-3 xl:gap-6">
                ...
                <div className="text-center xl:text-right tracking-wider">
                  ...
                  <p>
                    Vous pourrez ajouter des articles sur le site et être
                    contacté par des clients intéressés.
                  </p>
                </div>
                <button
                  onClick={() => Become_Trader()}
                  className="w-[180px] px-2 py-5 rounded-3xl btn-trade"
                >
                  <FontAwesomeIcon

...
const RegisterPage = () => {
    ...
    return (
        <div className="ms_Main flex justify-center items-center">
            ...
            <div className="text-center overflow-hidden relative md:w-8/12 h-full flex justify-center items-center rounded-xl md:border dark:border-none md:border-app-200 sm:shadow-md shadow-none my-6">
                <div className="auth-design dsn-1"></div>
                <div className="auth-design dsn-2"></div>
                <form className="w-full text-gray-600 py-10 sm:bg-white/50 backdrop-blur flex justify-center flex-wrap sm:dark:bg-dark dark:text-dark-app-100 overflow-hidden px-4" onSubmit={submitRegister}>

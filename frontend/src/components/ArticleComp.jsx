...
const ArticleComp = ({ art, articleRef, controller }) => {
  const imgLink =
    import.meta.env.VITE_IMG_URL + '/assets/img/articles/' + art.file_name
  ...
  const handleEdit = () => {
    openModal(
      <EditArticleForm id={artID} onClose={closeModal} />,
      'Editer un article',
    )
  }
  const handleDelete = () => {
  ...
  const articlePrice = artPrice.toLocaleString('fr-FR', {
    style: 'currency',
    currency: 'XAF',
  })
  ...
  return (
    ...
    >
      ...
      <div className="p-5 pb-3">
        {/* h-[70px] */}
        <div className="flex items-center text-left capitalize text-app pb-4 px-1 border-b border-app-300 dark:border-app-600">
          <span
            className="text-xl font-medium line-clamp-1 overflow-ellipsis"
            title={art.article}
          >
            {art.article}
          </span>
        </div>
        <div className="text-black/70 dark:text-white/70 mt-4">
          <div className="flex flex-col gap-2 px-2">
            {controller !== 'trader' && (
              <>
                ...
                <div className="flex gap-2 items-center">
                  <span className="text-app-500 justify-center items-center rounded-full">
            ...
            <div className="flex justify-between text-sm">
              <div className="flex gap-2 items-center">
                ...
                <span className="">
                  {art.quantity > 0 ? art.quantity + rest : 'Epuisé'}
                </span>
              </div>
              <div className="flex gap-2 items-center">
                <span className="text-app-500 flex justify-center items-center">
          ...
          <div className="flex items-center justify-center w-full mt-3">
              ...
              <>
                {inCart ? (
                  <button
                    ...
                    className="flex items-center justify-center p-2 text-white bg-gray-500 w-full rounded-xl gap-2 hover:bg-gray-600 btn-trans"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center p-2 text-white bg-app-700 hover:bg-app btn-trans w-full rounded-xl gap-2"
                  >
            ...
            {controller !== 'trader' && art.quantity < 1 && (
              <button
                onClick={handleAddCart}
                title="Ajouter au panier"
                className="flex items-center justify-center p-3 text-white bg-app-700 hover:bg-app btn-trans w-full rounded-xl gap-2 capitalize"
                disabled
              >
                <MdAddShoppingCart className="w-5 h-5" />
                <span>épuisé</span>

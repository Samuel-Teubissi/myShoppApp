...
const LoaderSkeletonArticle = () => {
    return (
        <>
            <div className="border border-app-200 shadow-md w-80 bg-app-050 rounded-xl overflow-hidden dark:bg-dark-div dark:border-app-800">
                ...
                <div className="">
                    ...
                    {/* <div className="flex justify-end pb-2 gap-1 pr-2 rounded-bl-xl rounded-br-xl">
                        {controller === 'trader' && <>

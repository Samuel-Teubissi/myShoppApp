...
import {
  ...
  faUserAlt,
  faXmark,
} from '@fortawesome/free-solid-svg-icons' // Version solid
import {
  faSquarePlus as faRegularSquarePlus,
  faArrowAltCircleUp as faRegularRightBracket,
  faBell,
} from '@fortawesome/free-regular-svg-icons' // Version regular
...
export default function DefaultRouterComp() {
  ...
  useEffect(() => {
    ...
    setVisibleSearchBar(
      location.pathname === '/home' || location.pathname === '/user',
    )
  }, [location.pathname])
  // useEffect(() => {
  // }, [isLoadingPage]);
  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        ...
        >
          <div
            className={`modal-Sidebar w-[25%] min-w-72 transition-transform duration-300 ease-out ${

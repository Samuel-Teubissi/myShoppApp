    ...
    return (
        <ModalContext.Provider value={{ openModal, closeModal }}>
            ...
            {modalContent && (<div className="inset-0 z-50 modal-overlay backdrop-blur-sm fixed top-0 left-0 w-full h-screen flex justify-center items-center btn-trans">
                <div className="bg-white modal-parent dark:text-dark-app-100 dark:border-app-900 p-2 md:px-5 pb-8 text-center shadow-sm relative btn-trans max-h-[90vh] max-w-[98%] w-[98%] xl:w-min xl:min-w-[50%] rounded-xl dark:bg-dark" ref={ModalRef} data-aos='zoom-in' data-aos-duration='100' data-aos-easing='ease-in-out'>
